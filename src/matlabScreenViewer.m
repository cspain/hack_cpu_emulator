%constants
global WINSIZE = [512, 256]
global WINCENTER = [320, 240]
global NUMPELS = 9900
global SCREEN_SIZE_BYTES = WINSIZE[0]*WINSIZE[1]/8
global SCREEN_WIDTH_PELS = WINSIZE[0]
global infile = open('C:\Users\Chris2.chris-HP-Select\Documents\GitHub\hack_cpu_emulator\screenTestGolden.txt','r')
global SCREEN = zeros((256, 512))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Read in n lines from a file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function readNlines(numLines, fileToRead)
    readInLines = []
...
function getScreenVal(coord, screenData)
